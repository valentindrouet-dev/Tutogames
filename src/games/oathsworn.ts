...

    {
      ...
      steps: [
        ...
        },
        {
          ...
          only: [1],
          body: [
            'Vous décidez pour la Compagnie entière : prenez un dé de points de vie, réglez-le sur la valeur de votre choix.',
            'Rien à cacher, rien à révéler. Appliquez la règle donnée à cet endroit du livre.',
          ],
          components: ['des'],
...

    {
      ...
      steps: [
        ...
        },
        {
          ...
          body: [
            'Les Oathsworn jouent dans l’ordre que vous voulez, et un même Oathsworn peut reprendre la main plusieurs fois dans le round.',
            'La phase s’arrête quand tous ont passé : un Oathsworn qui a passé peut encore jouer si un autre agit après lui.',
          ],
          warn: 'L’Animus non dépensé reste disponible pour une interruption pendant le tour d’un autre personnage, ou pendant la phase de rencontre.',
...

    {
      ...
      steps: [
        ...
        },
        {
          ...
          body: [
            'Une capacité marquée d’une main s’utilise hors du tour de son Oathsworn : pendant le tour d’un autre personnage, ou pendant la phase de rencontre.',
